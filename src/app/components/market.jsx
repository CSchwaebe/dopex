...
const ControlTabs = ({ buySell, setBuySell, callPut, setCallPut }) => (
...
const ExpiryDropdown = ({ expiry, setExpiry }) => (
...
const MarketTable = ({ data, setSelectedOption }) => (
  <div>
    <Table removeWrapper layout='fixed' aria-label="Options Market Table" className="space-between">
      <TableHeader>
...
export default function Market({
  ...
  return (
    <div className="p-4">
      ...
      <Spacer y={5} />
      {/* Table */}
      <MarketTable data={data} setSelectedOption={setSelectedOption} />
    </div>
  );
}
